...
const Contact = () => {
    ...
    () => [
      {
        ...
        title: "Email",
        value: "contact-me-roydev@inbox.ru",
        link: "mailto:contact-me-roydev@inbox.ru",
        isLink: true,
      },
      {
  ...
  }, [contactInfoRef, formRef, staggerChildren, fadeInRight]); // Добавлены зависимости
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (contactMethod === "email") {
        ...
        success = await sendTelegramMessage(telegramData);
      }
            ...
            {!isEmailJSConfigured() ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {submitStatus === "success" && (
                    <div className="alert alert-success animate-slide-in-up">
                      ...
                      <span className="animate-fade-in-error">
                        Сообщение отправлено успешно! Я отвечу в ближайшее
                        время.
                      </span>
                    </div>
                  )}
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting || isLoading || telegramLoading}
                    className={`btn w-full transition-all duration-500 ease-in-out transform ${
                      isSubmitting || isLoading || telegramLoading
