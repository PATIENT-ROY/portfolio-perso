import { Container, Instagram, Mail } from "lucide-react";
    ...
    <footer className="footer footer-center bg-base-300 p-10">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          ...
          <a
            href="https://github.com/PATIENT-ROY"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="GitHub"
            className="p-2 rounded-lg transition-all duration-300 hover:scale-110 hover:bg-gray-800 hover:shadow-lg"
          >
            <svg
