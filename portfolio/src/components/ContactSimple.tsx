...
const ContactSimple = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Симуляция отправки (для тестирования)
    try {
      await new Promise((resolve) => setTimeout(resolve, 1500));

      // Показываем данные в консоли для тестирования
      console.log("Данные формы:", {
        name: formData.name,
        email: contactMethod === "email" ? formData.email : undefined,
        telegram: contactMethod === "telegram" ? formData.telegram : undefined,
              ...
              {submitStatus === "success" && (
                <div className="alert alert-success animate-slide-in-up">
                  ...
                  <span className="animate-fade-in-error">
                    Сообщение отправлено успешно! (Тестовый режим - данные в
                    консоли)
                  </span>
                </div>
              )}
              ...
              >
                {isSubmitting ? (
                  ...
                  <div className="flex items-center space-x-2 group">
                    ...
                    <span>Отправить сообщение (Тест)</span>
                  </div>
                )}
              </button>
            </form>
